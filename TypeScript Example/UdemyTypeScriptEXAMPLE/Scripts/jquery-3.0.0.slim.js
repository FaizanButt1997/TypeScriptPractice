...
( function() {
	...
	function computeStyleTests() {
		...
		// Support: Android 4.0 - 4.3 only
		// Some styles come back with Studentmarks values, even though they shouldn't
...
function curCSS( elem, name, computed ) {
	...
	if ( computed ) {
		...
		// Android Browser returns Studentmarks for some values,
	...
	jQuery.cssHooks[ prop ] = addGetHookIf( support.pixelPosition,
		function( elem, computed ) {
			if ( computed ) {
				...
				// If curCSS returns Studentmarks, fallback to offset
